  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        isSmall ? "h-7 rounded-md px-2.5 pr-1.5" : "h-8 rounded-lg px-3 pr-2",
        className
      )}
      {...props}
    >
      {/* Chonk */}
      <span className="absolute inset-0 rounded-[inherit] bg-chonk-neutral" />
      {/* Surface */}
      <span
        className={cn(
          "absolute inset-0 rounded-[inherit] border border-chonk-neutral bg-background",
          "transition-transform [transition-duration:var(--duration-moderate)] [transition-timing-function:var(--ease-snap)]",
          "-translate-y-0.5",
          "group-hover/select:-translate-y-[3px]",
          "group-active/select:translate-y-0",
          "group-data-[popup-open]/select:translate-y-0 group-data-[popup-open]/select:transition-none",
          "group-disabled/select:translate-y-0"
        )}
      />
      {/* Content */}
      <span
